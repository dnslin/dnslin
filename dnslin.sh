...
docker_compose_amd64="https://github.do/https://github.com/docker/compose/releases/download/v2.0.1/docker-compose-linux-x86_64"
docker_compose_aarch64="https://github.do/https://github.com/docker/compose/releases/download/v2.0.1/docker-compose-linux-aarch64"
